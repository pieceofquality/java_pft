package com.pieceofquality.rest.tests;
...
import com.pieceofquality.rest.model.Issue;
...
public class TestBase {
  ...
  public boolean isIssueOpen(int issueId) {
    ...
    return !(issue[0].getState_name().equals("Resolved") || issue[0].getState_name().equals("Closed"));
  }
